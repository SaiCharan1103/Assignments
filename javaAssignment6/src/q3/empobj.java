...
public class empobj {
	public static void main(String[] args) {
		 ...
		 Employee emp_1 = new Employee(1, "Sai", "A", 10000L);
		 Employee emp_2 = new Employee(3, "Sai1", "B", 20000L);
		 Employee emp_3 = new Employee(2, "Sai2", "C", 30000L);
		 Employee emp_4 = new Employee(4, "Sai3", "D", 50000L);
		 Employee emp_5 = new Employee(5, "Sai4", "E", 60000L);
		 Employee emp_6 = new Employee(6, "Sai5", "F", 68600L);
		 Employee emp_7 = new Employee(7, "Sai6", "G", 37000L);
		 Employee emp_8 = new Employee(8, "Sai7", "H", 75000L);
		 Employee emp_9 = new Employee(9, "Sai8", "I", 24000L);
		 Employee emp_10 =new Employee(10, "Sai9", "J", 33000L);
